    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdSummary = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    Usn6 = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Usn15 = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    NetIncome = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Summaries", x => x.IdSummary);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdOsn = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Revenues = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    AllExpenses = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    MaterialExpenses = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    AccruedNds = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    InputNds = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    PercentageNds = table.Column<int>(type: "int", nullable: false),
                    PropertyTax = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TotalOsn = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Month = table.Column<DateTime>(type: "date", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Summaryosns", x => x.IdOsn);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdSalary = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IdEmploee = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Salaries_Employees_IdEmploee",
                        column: x => x.IdEmploee,
                        principalTable: "Employees",
                        principalColumn: "IdEmployee",
                        onDelete: ReferentialAction.Cascade);
                });
